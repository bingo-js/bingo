...
`glob` resolves with the paths of files matching one or more [glob patterns](https://github.com/SuperchupuDev/tinyglobby#readme), relative to the current directory.
